    ...
    <section className="ticket">
      ...
      <footer>
        ...
        <div className="btn-container">
          {/* If the logged in user is an employee and there's no employee ticket associated
          with the service ticket, then a button to claim the ticket should display */}
          ...
          {/* If the logged in user is the assigned employee for the ticket and there is
          no date completed, then a button to close the ticket should display */}
